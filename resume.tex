...
\datedsubsection{\textbf{Asian BRCA Variation: Ethnic-specificity, Evolution Origin \& Clinical Impact}}{2021 -- 2022}
\role{Population Genomics, Database Construction, Cancer Genetics}{}
\textbf{Project Overview:}\\
Performed a systematic analysis of BRCA1/2 germline variants in Asian populations, integrating literature mining, database curation, population-level comparison, evolutionary tracing, and clinical significance evaluation.

\textbf{Responsibilities:}
\begin{itemize}
  \item Curated and standardized \textbf{7587 BRCA variants} from \textbf{685,000+} Asian individuals across 40 countries; conducted HGVS normalization, annotation and ACMG classification.
  \item Built the open-access \textbf{dbBRCA-Asian} database using \textbf{LAMP (Linux, Apache, MySQL, PHP)} for online BRCA variant query, visualization and population comparison.
  ...
  \item Applied structure-based deleteriousness evaluation (Ramachandran Plot–Molecular Dynamics Simulation) to interpret ~500 unknown BRCA missense variants.
\end{itemize}

\textbf{Outcome:}\\
Generated the largest Asian BRCA variant dataset to date (7587 variants), revealed strong ethnic-specific patterns and evolutionary origins, and established the \texttt{https://genemutation.fhs.um.edu.mo/Asian-BRCA/} database for clinical and research use.
...
\begin{itemize}
  \item Zhao B, Li J, Sinha S, Qin Z, Kou SH, Xiao F, Lei H, Chen T, Cao W, Ding X, Wang SM*.\\
        \textbf{Pathogenic variants in human DNA damage repair genes mostly arose in recent human history.}\\
        \textit{BMC Cancer}, 2024.
  \item Qin Z\#, Li J\#, Tam B\#, \textbf{Zhao B\#}, Bhaskaran SP, Huang T, Wu X, Chian JS, Guo M,
        Kou SH, Lei H, Zhang L, Wang X, Lagniton PNP, Xiao F, Jiang X, Wang SM*.\\
        \textbf{Ethnic-specificity, evolution origin and deleteriousness of Asian BRCA variation revealed by over 7500 BRCA variants derived from Asian population.}\\
...
\begin{itemize}[parsep=0.3ex]
  ...
  \item Database - dbDDR-AncientHumans: \texttt{https://genemutation.boboz.io/dbDDR-AncientHumans}
  \item Database - Asian /textit{BRCA} Map: \texttt{https://genemutation.boboz.io/asian-brca}
\end{itemize}
