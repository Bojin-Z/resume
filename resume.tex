...
\basicInfo{
  ...
  \linkedin[Google Scholar]{https://scholar.google.com/citations?user=eWqpGUkAAAAJ}
}
...
\begin{itemize}
  ...
  \item Conducted GPU-based training (A100/H800), hyperparameter tuning, and context-dependent
...
\begin{itemize}[parsep=0.5ex]
  ...
  \item \textbf{Software:} Docker, \LaTeX, Adobe Illustrator, Adobe Photoshop
