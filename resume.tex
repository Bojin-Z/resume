...
\textbf{Outcome:}\\
Generated the largest Asian \textit{BRCA} variant dataset to date (7587 variants), revealed strong ethnic-specific patterns and evolutionary origins, and established the \texttt{https://genemutation.fhs.um.edu.mo/Asian-BRCA/} database for clinical and research use.
